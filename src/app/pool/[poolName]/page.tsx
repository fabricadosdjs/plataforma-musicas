...
import { Download, Heart, Play, TrendingUp, Users, Music, X, RefreshCw } from 'lucide-react';
                    ...
                    <div className="container mx-auto px-4 py-16">
                        <div className="text-center">
                            ...
                            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                                Explore todas as músicas da label {decodedPoolName} disponíveis na plataforma.
                            </p>
                            <div className="mt-8">
                ...
                <div className="max-w-4xl mx-auto bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-sm rounded-3xl p-8 border border-slate-600/30 shadow-2xl mb-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-300 text-lg">
                            Baixe {getAvailableTracksCount()} músicas disponíveis da pool <span className="text-amber-400 font-semibold">{decodedPoolName}</span> em lotes de 10 por vez
                        </p>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-4 flex-wrap">
                        <button
                            ...
                            className="bg-gradient-to-br from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white px-8 py-4 rounded-2xl font-bold text-xl transition-all duration-300 transform hover:scale-105 shadow-xl border border-amber-400/30 flex items-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:scale-100"
                        >
                            <Download className="h-7 w-7" />
                            Baixar {getAvailableTracksCount()} - {decodedPoolName}
                        </button>

                        {/* Botão Limpar Histórico */}
                        <button
                            onClick={() => clearDownloadHistory(filteredTracks)}
                            disabled={isBatchDownloading}
                            className="bg-gradient-to-br from-slate-600 to-slate-700 hover:from-slate-500 hover:to-slate-600 text-white px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl border border-slate-500/30 flex items-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed disabled:scale-100"
                    ...
                    {isBatchDownloading && (
                        <div className="mt-8 p-6 bg-slate-700/50 rounded-2xl border border-slate-500/30">
                            <div className="text-center mb-4">
                                <h4 className="text-xl font-bold text-white mb-2">Baixando músicas da pool {decodedPoolName}</h4>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="w-full bg-slate-600 rounded-full h-4 overflow-hidden">
                                    <div
                                        className="bg-gradient-to-r from-amber-500 to-orange-600 h-4 rounded-full transition-all duration-500 ease-out"
