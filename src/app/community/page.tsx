...
import { Search, Filter, Download, Heart, Play, Pause, Music, TrendingUp, Clock, Star, Users } from 'lucide-react';
            ...
            <main className="container mx-auto px-4 py-8 pt-20">
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-300">Músicas enviadas pelos DJs da comunidade</p>
                        </div>
                    </div>
                ...
                <div className="mb-8 bg-gray-900/30 backdrop-blur-sm rounded-2xl p-6 border border-gray-800 shadow-2xl">
                    <div className="flex flex-col items-center gap-4">
                        {/* Search Bar */}
                        <form onSubmit={handleSearch} className="flex items-center w-full max-w-md bg-gray-800 rounded-full px-4 py-3 border border-gray-700 focus-within:border-purple-500 transition-all duration-200">
                        ...
                        >
                            <Filter className={`h-4 w-4 ${hasActiveFilters ? 'text-purple-400' : 'text-gray-300'}`} />
                            <span className="text-sm font-medium">Filtros</span>
                            {hasActiveFilters && (
                                <span className="block h-2 w-2 rounded-full bg-purple-500 ring-2 ring-gray-800"></span>
                            )}
                        </button>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-32">
                        ...
                        <button onClick={handleClearFilters} className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors">Limpar Filtros</button>
                    </div>
                ) : (
                    <>
                        {sortedDates.length > 0 ? (
                            ...
                            <div className="text-center py-32">
                                ...
                                <h3 className="text-2xl font-bold text-white mb-4">Nenhuma música da comunidade encontrada</h3>
                                <p className="text-gray-400 mb-8">Não há músicas da comunidade disponíveis para os filtros selecionados.</p>
                                <button onClick={handleClearFilters} className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition-colors">Limpar Filtros</button>
                            </div>
                        )}
                    </>
