...
export default function ProfilePage() {
  ...
  const { playTrack, nextTrack, previousTrack, currentTrack, likedTracks: likedTrackIds, downloadedTracks: downloadedTrackIds, handleLike, handleDownload, isPlaying, setIsPlaying } = useAppContext();
  ...
  const showProfileNotice = isLoaded && user && !user.fullName;
          ...
          <div className="container mx-auto max-w-5xl px-8">
              <div className="flex items-end -mt-20">
                  ...
                  <div className="ml-6 flex-grow">
                      <h1 className="text-3xl font-extrabold text-gray-900">{user?.fullName || 'Nome do Usuário'}</h1>
                      <p className="text-md text-gray-500">{user?.primaryEmailAddress?.emailAddress}</p>
                  </div>
