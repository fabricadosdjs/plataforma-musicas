...
export default function ProgressiveHousePage() {
    const genreName = "Progressive House";
    ...
    useEffect(() => {
        const fetchGenreTracks = async () => {
            try {
                setLoading(true);
                const response = await fetch(`/api/tracks/genre/${encodeURIComponent(genreName)}`);
                if (response.ok) {
                    ...
                    if (tracksData.length > 0) {
                        ...
                        const uniquePools = new Set(tracksData.map((t: Track) => t.pool)).size;
                    ...
                    <div className="container mx-auto px-4 py-16">
                        <div className="text-center">
                            ...
                            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                                Explore todas as músicas do estilo {genreName} disponíveis na plataforma.
                            </p>
                            <div className="mt-8">
