...
export async function generateMetadata({ params }: { params: { genreName: string } }): Promise<Metadata> {
    ...
    const genreSeoData = {
        'brazilian funk': {
            title: 'Brazilian Funk - Funk Carioca | Músicas, Downloads e História',
        ...
        'hip hop': {
            title: 'Hip Hop - Rap, Beat e Cultura Urbana | Músicas e Downloads',
        ...
        'electronic': {
            title: 'Electronic - Música Eletrônica | EDM, Techno e House',
        ...
        'pop': {
            title: 'Pop - Música Popular | Hits, Singles e Downloads',
        ...
        'rock': {
            title: 'Rock - Música Rock | Classic Rock, Alternative e Metal',
        ...
        'house': {
            title: 'House - Música Eletrônica Dançante | Chicago House, Deep House e Tech House',
        ...
        'hip hop': {
            title: 'Hip Hop - Cultura Urbana e Música de Resistência | Rap, Beat e Expressão Social',
        ...
        'tech house': {
            title: 'Tech House - Música Eletrônica Techno + House | Batidas Minimalistas e Groove',
