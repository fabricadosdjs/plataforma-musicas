...
/**
 * Função para o botão Play/Pause.
 */
...
/**
 * Função para o botão Aleatório (Shuffle).
 */
...
/**
 * Função para adicionar a playlist à biblioteca.
 */
...
/**
 * Função para filtrar as músicas com base em uma busca.
 */
const handleSearch = (
    query: string, 
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="bg-white/10 border border-white/20 rounded-full py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-white/50 appearance-none cursor-pointer"
                        >
