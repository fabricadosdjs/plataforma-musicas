...
import { Brain, Cloud, LayoutDashboard, Music, PlusCircle, Users, MessageSquare, Package, Download, Image, List } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#202124] text-white">
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/admin/messages" className="p-6 rounded-lg transition-colors" style={{ backgroundColor: '#2d2f32' }}
            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#374151'}
            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#2d2f32'}>
            <MessageSquare size={48} className="mb-4 text-orange-400" />
            <h2 className="text-xl font-semibold mb-2">Recados</h2>
            <p className="text-gray-400">Gerenciar mensagens e avisos para usuários</p>
          </Link>

          <Link href="/admin/custom-items" className="p-6 rounded-lg transition-colors" style={{ backgroundColor: '#2d2f32' }}
            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#374151'}
            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#2d2f32'}>
            <Package size={48} className="mb-4 text-pink-400" />
            <h2 className="text-xl font-semibold mb-2">Itens Personalizados</h2>
            <p className="text-gray-400">Adicionar e gerenciar itens customizados</p>
          </Link>
          ...
          <Link href="/manager/playlist" className="p-6 rounded-lg transition-colors" style={{ backgroundColor: '#2d2f32' }}
            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#374151'}
            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#2d2f32'}>
            <List size={48} className="mb-4 text-green-400" />
            <h2 className="text-xl font-semibold mb-2">Gerenciar Playlists</h2>
