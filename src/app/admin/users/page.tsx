            ...
            <div className="container mx-auto px-6 py-8">
                ...
                <div className="mb-6 flex justify-end">
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-pink-600 hover:bg-pink-700 text-white rounded-lg transition-colors font-medium shadow-lg"
                    >
                        ...
                        <table className="w-full table-fixed">
                            <thead className="bg-[#5a6b4a]">
                                <tr>
                                    ...
                                    <th className="w-[6%] px-3 py-3 text-left text-xs text-gray-300">
                                        Deemix
                                    </th>
                                    <th className="w-[7%] px-3 py-3 text-center text-xs text-gray-300">
                                        Ações
                                    </th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-700">
                                {filteredUsers.map((user, index) => (
                                    <tr key={user.id} className={`hover:bg-gray-700/50 transition-colors ${index % 2 === 0 ? 'bg-[#1F1F21]' : 'bg-[#1C1C1F]'}`}>
                                        <td className="px-4 py-3">
                                            <div className="text-sm text-gray-300" title={user.name}>{user.name}</div>
                                        </td>
                                        <td className="px-3 py-3">
                                            <div className="flex items-center gap-1 group">
                                                <span className="text-sm text-gray-300 truncate flex-1" title={user.whatsapp || ''}>
                                                    {user.whatsapp || '-'}
                                                </span>
                                                {user.whatsapp && user.whatsapp.trim() && (
                                                    <button
                                                        onClick={() => copyToClipboard(user.whatsapp!.trim(), 'WhatsApp')}
                                                        className="opacity-0 group-hover:opacity-100 transition-opacity p-1 hover:bg-gray-600 rounded flex-shrink-0"
                                        ...
                                        <td className="px-3 py-3">
                                            <div className="flex items-center gap-1 group">
                                                <span className="text-xs text-gray-300 truncate flex-1" title={user.email}>
                                                    {user.email}
                                                </span>
                                                <button
                                        ...
                                        <td className="px-3 py-3">
                                            {(() => {
                                                ...
                                                if (!userPlan) {
                                                    return <span className="text-xs text-gray-500">Sem plano</span>;
                                                }
                                                return (
                                                    <div className="flex items-center gap-1">
                                                        <span className="text-lg">{userPlan.icon}</span>
                                                        <div className="flex flex-col flex-1">
                                                            <span className="text-xs font-semibold text-white">{userPlan.name.split(' ')[1]}</span>
                                                            <span className="text-xs text-gray-400">{userPlan.name.split(' ')[0]}</span>
                                                        </div>
                                                        {hasCustomBenefits && (
                                        ...
                                        <td className="px-3 py-3">
                                            <span className={`text-sm ${user.vencimento
                                                ? isVencido(user.vencimento)
                                                    ? 'text-red-400 bg-red-900/20 px-1 py-0.5 rounded'
                                                    : isVencimentoProximo(user.vencimento)
                                                        ? 'text-orange-300 bg-orange-900/20 px-1 py-0.5 rounded'
                                                        : 'text-gray-300'
                                                : 'text-gray-500'
                                                }`}>
                                        ...
                                        <td className="px-3 py-3">
                                            <button
                                                ...
                                                className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium transition-colors ${user.status === 'ativo'
                                        ...
                                        <td className="px-3 py-3">
                                            <button
                                                ...
                                                disabled={updating === user.id}
                                                className={`inline-flex items-center justify-center w-8 h-6 rounded text-xs font-medium transition-colors ${user.deemix
