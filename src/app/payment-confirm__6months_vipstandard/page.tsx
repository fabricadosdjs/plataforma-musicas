...
export default function PaymentConfirmVIPStandard6Months() {
    ...
    const openWhatsApp = () => {
        const message = `Olá! Acabei de assinar o plano VIP PADRÃO SEMESTRAL (6 meses) e gostaria de reivindicar minha assinatura. Plano: R$ 35,70/mês por 6 meses (R$ 42,00 original com 15% desconto - R$ 214,20 total).`;
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="text-center">
                                    ...
                                    <h3 className="text-xl font-bold mb-2">Plano VIP Padrão</h3>
                                ...
                                <div className="text-center">
                                    ...
                                    <h3 className="text-xl font-bold mb-2">R$ 35,70/mês</h3>
                                    <p className="text-gray-400">R$ 42,00/mês (15% off)</p>
                                    <p className="text-gray-400">Total: R$ 214,20</p>
                                </div>
                            </div>
                        </motion.div>
                    </motion.div>
                                        ...
                                        <CardContent className="p-6">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex items-center gap-3 p-3 bg-purple-500/10 rounded-lg">
                                                    ...
                                                    <span className="text-gray-300">100 downloads por dia</span>
                                                </div>
                                                <div className="flex items-center gap-3 p-3 bg-purple-500/10 rounded-lg">
                                                ...
                                                <div className="flex items-center gap-3 p-3 bg-purple-500/10 rounded-lg">
                                                    ...
                                                    <span className="text-gray-300">Solicitação de packs (8/semana)</span>
                                                </div>
                                                <div className="flex items-center gap-3 p-3 bg-purple-500/10 rounded-lg">
                                                    <Headphones className="w-5 h-5 text-purple-400" />
                                                    <span className="text-gray-300">Deezer Premium: R$ 8,40/mês</span>
                                                </div>
                                                <div className="flex items-center gap-3 p-3 bg-purple-500/10 rounded-lg">
                                                    <Crown className="w-5 h-5 text-purple-400" />
                                                    <span className="text-gray-300">Deemix: R$ 20,30/mês</span>
                                                </div>
                                            </div>
                                        </CardContent>
                                    </Card>
                                        ...
                                        <CardContent className="p-6">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex justify-between items-center p-3 bg-green-500/10 rounded-lg">
                                                    ...
                                                    <span className="text-green-400 font-semibold">R$ 35,70</span>
                                                </div>
                                                <div className="flex justify-between items-center p-3 bg-blue-500/10 rounded-lg">
                                                    <span className="text-gray-300">Preço Original:</span>
                                                    <span className="text-blue-400 font-semibold">R$ 42,00/mês</span>
                                                </div>
                                                <div className="flex justify-between items-center p-3 bg-purple-500/10 rounded-lg">
                                                ...
                                                <div className="flex justify-between items-center p-3 bg-green-500/10 rounded-lg">
                                                    ...
                                                    <span className="text-green-400 font-semibold">R$ 214,20</span>
                                                </div>
                                                <div className="flex justify-between items-center p-3 bg-blue-500/10 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/60 border border-gray-700/50 relative overflow-hidden">
                                ...
                                <CardContent className="p-6 text-center relative">
                                    ...
                                    <p className="text-gray-300 text-sm leading-relaxed">Acesso completo a todos os recursos do plano VIP Padrão com benefícios exclusivos</p>
