...
export default function PaymentConfirmVIPBasic6Months() {
    ...
    const openWhatsApp = () => {
        const message = `Olá! Acabei de assinar o plano VIP BÁSICO SEMESTRAL (6 meses) e gostaria de reivindicar minha assinatura. Plano: R$ 29,75/mês por 6 meses (R$ 35,00 original com 15% desconto - R$ 178,50 total).`;
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="text-center">
                                    ...
                                    <h3 className="text-xl font-bold mb-2">Plano VIP Básico</h3>
                                ...
                                <div className="text-center">
                                    ...
                                    <h3 className="text-xl font-bold mb-2">R$ 29,75/mês</h3>
                                    <p className="text-gray-400">R$ 35,00/mês (15% off)</p>
                                    <p className="text-gray-400">Total: R$ 178,50</p>
                                </div>
                            </div>
                        </motion.div>
                    </motion.div>
                                        ...
                                        <CardContent className="p-6">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex items-center gap-3 p-3 bg-purple-500/10 rounded-lg">
                                                    ...
                                                    <span className="text-gray-300">50 downloads por dia</span>
                                                </div>
                                                <div className="flex items-center gap-3 p-3 bg-purple-500/10 rounded-lg">
                                                ...
                                                <div className="flex items-center gap-3 p-3 bg-purple-500/10 rounded-lg">
                                                    ...
                                                    <span className="text-gray-300">Solicitação de packs (4/semana)</span>
                                                </div>
                                                <div className="flex items-center gap-3 p-3 bg-purple-500/10 rounded-lg">
                                                    <Headphones className="w-5 h-5 text-purple-400" />
                                                    <span className="text-gray-300">Deezer Premium: R$ 9,75/mês</span>
                                                </div>
                                            </div>
                                        </CardContent>
                                    </Card>
                                        ...
                                        <CardContent className="p-6">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex justify-between items-center p-3 bg-green-500/10 rounded-lg">
                                                    ...
                                                    <span className="text-green-400 font-semibold">R$ 29,75</span>
                                                </div>
                                                <div className="flex justify-between items-center p-3 bg-blue-500/10 rounded-lg">
                                                    <span className="text-gray-300">Preço Original:</span>
                                                    <span className="text-blue-400 font-semibold">R$ 35,00/mês</span>
                                                </div>
                                                <div className="flex justify-between items-center p-3 bg-purple-500/10 rounded-lg">
                                                ...
                                                <div className="flex justify-between items-center p-3 bg-green-500/10 rounded-lg">
                                                    ...
                                                    <span className="text-green-400 font-semibold">R$ 178,50</span>
                                                </div>
                                                <div className="flex justify-between items-center p-3 bg-blue-500/10 rounded-lg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/60 border border-gray-700/50 relative overflow-hidden">
                                ...
                                <CardContent className="p-6 text-center relative">
                                    ...
                                    <p className="text-gray-300 text-sm leading-relaxed">Acesso completo a todos os recursos do plano VIP Básico com benefícios exclusivos</p>
