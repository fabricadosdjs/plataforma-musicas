// ============================================
// SCRIPT PRISMA PARA REMOVER TRACKS
// ============================================
// Execute com: node remove_tracks_prisma.js
    ...
    try {
        ...
        const tracksToRemove = await prisma.track.findMany({
            where: {
                ...
                OR: [
                    {
                        songName: 'BARBIE GIRL (EXTENDED VERSION)',
                        artist: 'AQUA',
                        version: 'Extended Version'
                    },
                    {
                        songName: 'AYLA PART II (EXTENDED MIX)',
                        artist: 'AYLA',
                        version: 'Extended Mix'
                    },
                    {
                        songName: 'SEVEN DAYS AND ONE WEEK (CLUB MIX)',
                        artist: 'B.B.E.',
                        version: 'Club Mix'
                    }
                ]
